...
#define RS485_RE_GPIO_PIN                   SYS_GPIO_PIN8
#define RS485_RE_GPIO_CLK_ENABLE()          do{ RCC->AHB1ENR |= 1 << 6; }while(0)   /* PG口时钟使能 */

#define RS485_TX_GPIO_PORT                  GPIOA
#define RS485_TX_GPIO_PIN                   SYS_GPIO_PIN2
#define RS485_TX_GPIO_AF                    7                                       /* AF功能选择 */
#define RS485_TX_GPIO_CLK_ENABLE()          do{ RCC->AHB1ENR |= 1 << 0; }while(0)   /* PA口时钟使能 */

#define RS485_RX_GPIO_PORT                  GPIOA
#define RS485_RX_GPIO_PIN                   SYS_GPIO_PIN3
#define RS485_RX_GPIO_AF                    7                                       /* AF功能选择 */
#define RS485_RX_GPIO_CLK_ENABLE()          do{ RCC->AHB1ENR |= 1 << 0; }while(0)   /* PA口时钟使能 */
