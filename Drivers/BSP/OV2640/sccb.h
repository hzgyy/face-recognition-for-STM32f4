...
#define SCCB_SCL_GPIO_PIN                SYS_GPIO_PIN6
#define SCCB_SCL_GPIO_CLK_ENABLE()       do{ RCC->AHB1ENR |= 1 << 3; }while(0)   /* PD口时钟使能 */

#define SCCB_SDA_GPIO_PORT               GPIOD
#define SCCB_SDA_GPIO_PIN                SYS_GPIO_PIN7
#define SCCB_SDA_GPIO_CLK_ENABLE()       do{ RCC->AHB1ENR |= 1 << 3; }while(0)   /* PD口时钟使能 */
